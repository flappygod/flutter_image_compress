#import "FlutterImgCompressPlugin.h"
#import <Photos/Photos.h>

@implementation FlutterImgCompressPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"flutter_img_compress"
                                     binaryMessenger:[registrar messenger]];
    FlutterImgCompressPlugin* instance = [[FlutterImgCompressPlugin alloc] init];
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    if([@"compressImage" isEqualToString:call.method]){
        ...
        NSInteger quality=(qualityStr ==nil || [qualityStr isEqual:[NSNull null]] ) ? 90:[qualityStr integerValue];
        NSInteger maxWidth=(maxWidthStr ==nil || [maxWidthStr isEqual:[NSNull null]]) ? 0:[maxWidthStr integerValue];
        NSInteger maxHeight=(maxHeightStr ==nil|| [maxHeightStr isEqual:[NSNull null]]) ? 0:[maxHeightStr integerValue];
        NSInteger maxSize=(maxSizeStr ==nil|| [maxSizeStr isEqual:[NSNull null]]) ? 0:[maxSizeStr integerValue];
